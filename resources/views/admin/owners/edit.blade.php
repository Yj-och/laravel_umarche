                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            <div class="flex flex-col text-center w-full mb-12">
                                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Owner Information Editing</h1>
                            </div>
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                <form method="post" action="{{ route('admin.owners.update',['owner' => $owner->id])}}">
                                    ...
                                    <div class="p-2 w-full mt-4 flex justify-around">
                                        <button type="botton" onclick="location.href='{{ route('admin.owners.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">Return</button>
