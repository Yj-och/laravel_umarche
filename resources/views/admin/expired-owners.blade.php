                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <form id="delete_{{$owner->id}}" method="post"action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id])}}">
                                     @csrf
                                  <td class="px-4 py-3">
                                    <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" class="text-white px-3 py-2 bg-red-400 border-0 focus:outline-none hover:bg-red-500 rounded">CompletelyDelete</a>
                                  </td>
                                </form>
                                </tr>
                                @endforeach
